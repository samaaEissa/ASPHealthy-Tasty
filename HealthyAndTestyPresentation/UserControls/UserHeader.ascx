<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UserHeader.ascx.cs" Inherits="HealthyAndTestyPresentation.UserControls.UserHeader" %>
<style>
    .topnav {
    overflow: hidden;
