<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Registeration.aspx.cs" Inherits="HealthyAndTestyPresentation.Registeration" %>
...
<body>
    <form  runat="server">
        ...
        <uc1:RegisterWebUserControl runat="server" ID="RegisterWebUserControl" />
